...
class _ProfileDrawerState extends State<ProfileDrawer> {
  ...
  bool _hasChanges() {
    return _fullNameController.text != _initialValues['fullName'] ||
        _emailController.text != _initialValues['email'] ||
        _identificationController.text != _initialValues['identification'] ||
        _dateController.text != _initialValues['date'] ||
        _addressController.text != _initialValues['address'] ||
        _telephoneController.text != _initialValues['telephone'] ||
        (selectedValue ?? '') != _initialValues['gender'] ||
        image_upload != null;
  }
          ...
          actions: [
            Padding(
              ...
              child: FloatingActionButton(
                onPressed: () async {
                  bool hasImageUpload = image_upload != null;

                  if (!hasImageUpload && !_hasChanges()) {
                    QuickAlert.show(
                      context: context,
                  ...
                  if (_formKey.currentState!.validate()) {
                    print('Formulario válido, actualizando datos...');
